...
class Home extends Component {
  ...
  loadOldMemo() {
    ...
    const lastId = this.props.memoData[this.props.memoData.length - 1]._id;
  ...
  render() {
    ...
    return (
      <div className="wrapper">
        ...
        <MemoList
          data={this.props.memoData} currentUser={this.props.currentUser}
...
const mapDispatchToProps = dispatch => ({
  ...
  memoListRequest: (isInitial, listType, id, username) => dispatch(memoListRequest(isInitial, listType, id, username)),
  memoEditRequest: (id, index, contents) => dispatch(memoEditRequest(id, index, contents)),
